...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('backbone'), require('underscore-99xp'), require('https'), require('http')) :
    typeof define === 'function' && define.amd ? define(['exports', 'backbone', 'underscore-99xp', 'https', 'http'], factory) :
    (global = global || self, factory(global.BackboneRequest = {}, global.Backbone, global._, global.https, global.http));
}(this, function (exports, Backbone, _, https, http$1) { 'use strict';
