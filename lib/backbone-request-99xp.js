...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('backbone'), require('underscore-99xp'), require('app-exception'), require('https'), require('http')) :
    typeof define === 'function' && define.amd ? define(['exports', 'backbone', 'underscore-99xp', 'app-exception', 'https', 'http'], factory) :
    (global = global || self, factory(global.BackboneRequest = {}, global.Backbone, global._, global.AppException, global.https, global.http));
}(this, function (exports, Backbone, _, AppException, https, http$1) { 'use strict';
