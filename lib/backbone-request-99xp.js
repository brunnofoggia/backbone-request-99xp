...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('backbone'), require('app-exception'), require('backbone-99xp'), require('underscore-99xp'), require('https'), require('http')) :
    typeof define === 'function' && define.amd ? define(['exports', 'backbone', 'app-exception', 'backbone-99xp', 'underscore-99xp', 'https', 'http'], factory) :
    (global = global || self, factory(global.BackboneRequest = {}, global.Backbone, global.AppException, global.bbx, global._, global.https, global.http));
}(this, function (exports, Backbone, AppException, bbx, _, https, http$1) { 'use strict';
    ...
    var exec = function (options, req = null, res = null) {
      ...
      var reqOpts = _.defaults2(_.pick(options, 'url', 'method', 'headers', 'data', 'timeout'), defaults); // default promise calls
